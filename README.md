...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-x8tagua.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-x8tagua.containers.anotherwebservice.com/
...
```
git clone git@github.com:johnkennyuk/container-x8tagua.git
cd container-x8tagua
```
...
```
docker attach container-x8tagua
```
